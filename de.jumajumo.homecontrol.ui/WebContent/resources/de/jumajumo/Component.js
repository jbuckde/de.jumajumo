jQuery.sap.declare("jumajumo.Component");
		...
		.extend(
				"jumajumo.Component",
				{
						...
						routing :
						{
							...
							[
							{
								...
								[
										...
										{
											pattern : "homeAutomationObject/pictures",
											name : "homeAutomationObjectImageGroupOverview",
											view : "HomeAutomationObjectImageGroupOverview",
											viewPath : "jumajumo.ha.view",
											viewLevel : 2,
											targetAggregation : "detailPages",
											subroutes :
											[
											{
												pattern : "homeAutomationObjectImageGroupDetail/{path}",
												name : "homeAutomationObjectImageGroupDetail",
												view : "HomeAutomationObjectImageGroupDetail",
												viewPath : "jumajumo.ha.view",
												viewLevel : 3,
												targetAggregation : "detailPages",
											} ]
					...
					init : function()
					{
						...
						// on none phone devices route to the empty page / keep
						// the master page
						// on phone device
						if (!sap.ui.Device.system.phone)
						{
							router.myNavToWithoutHash("jumajumo.ha.view.Empty",
									"XML", false);
						}
